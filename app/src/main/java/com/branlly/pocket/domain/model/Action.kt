...
sealed interface InputValue<out T> {
    ...
    data class FromTrigger(
        val key: TriggerValueKey,
    ) : InputValue<Nothing>
}
...
sealed interface ShortcutAction {
    ...
    data class Wait(
        ...
        init {
            require(durationMillis in 100L..86_400_000L)
        }
